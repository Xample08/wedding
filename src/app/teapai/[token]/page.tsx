...
const CONTENT = {
    FAMILY: {
        EN: {
            ...
            welcome_message: "Dear \n {name}",
            question_message: "Will you attend?",
            field_1: "Name",
            field_2: "Number of Guest",
        ...
        ID: {
            ...
            attending_yes: "Ya, saya hadir",
            attending_no: "Tidak bisa hadir",
            thank_you: "Terima Kasih!",
            success_msg_yes:
                "Kami menantikan kehadiran Anda di acara tersebut.",
            success_msg_no:
                "Kami telah menerima respons Anda. Kami akan merindukan Anda!",
    ...
    PUBLIC: {
        EN: {
            ...
            thank_you: "Thank You!",
            success_msg_yes:
                "Thank you for your confirmation. We look forward to seeing you at the event.",
            success_msg_no: "Thank you for letting us know. We’ll miss you",
            change_response: "Need to change your response?",
            entry_ticket: "Entry Ticket",
        },
        ID: {
            ...
            confirm: "Konfirmasi",
            attending_yes: "Saya hadir",
            attending_no: "Saya tidak hadir",
            thank_you: "Terima Kasih!",
            success_msg_yes:
                "Terima kasih atas konfirmasi Anda. Kami menunggu kehadiran anda.",
            success_msg_no: "Terima kasih atas konfirmasinya.",
            change_response: "Perlu mengubah respons Anda?",
            entry_ticket: "Tiket Masuk",
        },
    },
...
export default function TeapaiGuestPage({
    params,
}: {
    ...
    return (
        <div className="fixed inset-0 w-full h-full bg-slate-900 flex items-center justify-center font-serif overflow-hidden overscroll-none touch-pan-y">
            <main className="relative h-full w-full max-w-[435px] bg-[#fbf6e8] shadow-2xl overflow-hidden font-serif">
                {/* Language Switcher */}
                ...
                <div
                    className="relative z-10 h-full w-full overflow-y-auto pt-8 pb-12 px-6 scroll-smooth"
                        ...
                        {!submitted ? (
                            ...
                            >
                                <div className="text-center mb-6">
                                    <h1 className="text-2xl font-bold text-[#b4352a] mb-1 whitespace-pre-line leading-tight">
                                        {content.title}
                                    </h1>
                                    <p className="text-slate-500 italic text-xs tracking-wide mt-5">
                                        {content.sub_title}
                                    </p>
                                    <div className="mt-4 text-lg font-medium text-slate-800 leading-snug">
                                        {renderedWelcomeContent}
                                    </div>
                                </div>
